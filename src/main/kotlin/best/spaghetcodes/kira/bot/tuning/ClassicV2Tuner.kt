...
object ClassicV2Tuner {
    ...
    private val specs = listOf(
        ...
        specL("openSpacingMax", 850.0, 920.0, 10.0, 900.0),       // 910→900
        ...
        specI("bowSlowFramesNeeded", 2.0, 6.0, 1.0, 2.0),          // 4→2
        ...
        specI("closeBurstWindowMinMs", 200.0, 360.0, 10.0, 210.0),       // 270→210
        ...
        // JUMP
        specF("antiJumpZoneDist", 8.0, 8.4, 0.05, 8.15),                 // 8.2→8.15
